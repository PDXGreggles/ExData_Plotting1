...
##Plot #4 - a series of 4 plots shoting the global active power, voltage, the submetering data, and global reactive power 
png("Plot4.png")
par(mfrow= c(2,2))
...
with(power, plot(datetime,Global_reactive_power, type="l",ylab = "Global Reactive power (killowatts)",xlab="datetime"))
dev.off()